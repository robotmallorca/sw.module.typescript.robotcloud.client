...
import {
  ...
  ServiceInstanceConfigClient,
  ServiceInstanceDataClient,
  ServiceInstanceAlertsClient,
  ServiceInstanceHistoricClient,
  HistoricAggregateFunction,
} from "../../../types/services";
import {
  ServiceDataRequestParams,
  ServiceInstanceDataRequestParams,
  ServiceInstanceAlertRequestParams,
  ServiceAlertRequestParams,
  ServiceInstanceHistoricParams,
  ServiceInstanceHistoricAggregateParams,
} from "../../../types/request-params";

export class GenericInstanceConfigClient<
  T,
...
export class GenericInstanceDataClient<
  T,
> implements ServiceInstanceDataClient<T> {
  private readonly serviceName: string;
...
export class GenericInstanceAlertClient<
  T,
> implements ServiceInstanceAlertsClient<T> {
  private readonly serviceName: string;
...
export class GenericInstanceHistoricClient<
  T,
> implements ServiceInstanceHistoricClient<T> {
  private readonly serviceName: string;
